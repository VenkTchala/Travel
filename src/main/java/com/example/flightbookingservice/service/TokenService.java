...
public class TokenService
{
    ...
    public String generateToken(Authentication authentication) {
        ...
        final JwtClaimsSet claims = JwtClaimsSet.builder().issuer("self").issuedAt(now.plus(1L, ChronoUnit.HOURS)).subject(authentication.getName()).claim("scope", scope).build();
